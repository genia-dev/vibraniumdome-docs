...
<Warning>This code sample requires OpenAI API Key, you can generate one [here](https://platform.openai.com/api-keys)</Warning>

#### Install the Vibranium Dome SDK

```
pip3 install vibranium-dome-sdk openai
```
